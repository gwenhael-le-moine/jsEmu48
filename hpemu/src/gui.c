...
static GuiPanel panels[PANEL_COUNT] = {
    ...
    430,    0,	NULL,	pdebug_show,	pdebug_hide,	pdebug_down,
    pdebug_up }, { 10,   40,     340,    430,    0,	NULL, pfiles_show,
    pfiles_hide,	pfiles_down,	pfiles_up }, { 10,   40,     340, 430,
    0,	NULL,	pabout_show,	pabout_hide,	pabout_down,	pabout_up },
     */
};
...
void gui_show_panel(int i) {
  ...
  panels[i].x-1, panels[i].y-1, panels[i].x+panels[i].w,
  panels[i].y+panels[i].h, color[C_PANEL_BORDER]);
